...
from libqtile import hook, layout, log_utils, qtile
...
def get_default_keys(mod: str, rofi: Rofi | None = None) -> list[Key]:
    env = os.environ.copy()
    ...
    return [
        ...
        Key(
            [mod, "shift"], "Tab", lazy.layout.previous(), desc="Move window focus to prev window"
        ),
